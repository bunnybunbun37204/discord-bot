...
var AIMLParser = function(botAttributesParam){
    var self = this;
    ...
    this.getResult = function(clientInput, cb){
        ...
        if(isAIMLFileLoaded){
            ...
            var getResultWrapper = function(clientInput, cb){
                return function(){
                    self.getResult(clientInput, cb);
                };
            };

            setTimeout(getResultWrapper(clientInput, cb), 1000);
        }
    };
};
